...
public class SectorConverter implements Converter {
	...
	public List<Sector> getItems() {
		return getEstadioController().getSectoresDisponiblesFromFestivalAndDia(getEstadioController().getFestivalElegido(),getEstadioController().getDiaElegido());
	}
